...
```
"/Users/jeffgoldsmith/Library/CloudStorage/OneDrive-cumc.columbia.edu/Work/Teaching/P8105/fall_2026/data/FAS_litters.csv"
```
...
pups_df = 
	read_csv(
		file = "~/Desktop/data_wranging_i/data/FAS_litters.csv",
		skip = 3)
```
