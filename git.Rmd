...
First, make sure your GitHub username and email are established on your computer. You can do this in a terminal window, but I recommend running
```{r, eval = FALSE}
usethis::use_git_config(user.name = "YOUR NAME", user.email = "your_GH_email")
```
substituting your name and email. Next, you need to create a Personal Access Token. Again, there are several ways to do this, but I recommend you use
```{r, eval = FALSE}
