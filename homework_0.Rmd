...
Due: September 4 at 10:00am. 

### Problem 1

Download and install the latest versions of [R](https://cran.r-project.org) (4.6.1) and [RStudio](https://posit.co/download/rstudio-desktop/) (2026.08.2+200). 
...
install.packages(
  c("tidyverse", "knitr", "rmarkdown", "janitor", "broom", "here", "readxl", 
    "haven", "ggridges", "ggthemes", "leaflet", "viridis", "skimr", 
    "rvest", "httr", "flexdashboard", "devtools", "usethis", "modelr", "mgcv", 
    "tidytext", "shiny", "patchwork", "glmnet", "plotly", "remotes", "palmerpenguins"))
...
Join the course [Slack channel](https://join.slack.com/t/p8105datascie-n2t4675/shared_invite/zt-3cgdmb284-PaTr2SFNnuC4qUPoi1hFmw).
