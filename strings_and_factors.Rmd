...
First we'll import the data, clean a variable name, and take a quick look.
...
To simplify things, I'll remove inspections with scores other than `A`, `B`, or `C`, and also remove the restaurants with missing borough information. I'll also clean up borough names a bit.
