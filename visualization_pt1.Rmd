...
We'll be working with NOAA weather data, which is available in the `p8105.datasets package`. (Note: these data were previously accessed using the `rnoaa::meteo_pull_monitors` function; due to changes in NOAA's API, this package has been discontinued).
