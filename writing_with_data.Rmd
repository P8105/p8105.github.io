...
The formatting for both PDF and Word documents can be controlled through options as well, although these can be tricky to control (especially for Word documents). If you're really interested in generating reports using Word, you may want to read up on the [`redoc`](https://github.com/tribalxg/redoc) package!
